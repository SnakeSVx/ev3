...
public abstract class RCXAbstractPort {
   ...
   private class RCXInputStream extends InputStream {
      ...
      * @throws java.io.IOException is never thrown
      ...
      * @throws java.io.IOException is thrown when the read is timed out
   ...
   private class RCXOutputStream extends OutputStream {
      ...
      * @param b The byte.
      * @throws java.io.IOException if the byte could not be written to the stream
      */
