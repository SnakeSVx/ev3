...
public class NXTLineLeader extends I2CSensor {
	 ...
	 * <p>
	 * See {@link #getReadingLimit(int, lejos.nxt.addon.NXTLineLeader.LineColor)} and
	 * {@link #getCalibrationData(int, lejos.nxt.addon.NXTLineLeader.LineColor)} for details.
	 */
	 ...
	 * is advised to use {@link #sendCommand(lejos.nxt.addon.NXTLineLeader.Command)} instead.
	 * 
	 * @param cmd
	 *            the character based command
	 * @deprecated use {@link #sendCommand(lejos.nxt.addon.NXTLineLeader.Command)} instead
	 */
	@Deprecated
